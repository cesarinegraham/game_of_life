...
RGB = imread('GameOfLifeCivilizations.jpg');
subplot(1,2,1)
...
dataLog = sprintf(dataLog);  
fileId = fopen("Graham_Final_TimeLogging.txt", 'a'); 
fprintf(fileId, "%s\n",dataLog);
fclose(fileId);
...
fprintf("\n\n<strong>The data has been compiled into Graham_Final_TimeLogging.txt</strong>\n");
